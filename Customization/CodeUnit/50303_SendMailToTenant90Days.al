        ...
        if Rec."Property_M Status" = 'Approved' then begin
            ...
            if CompanyInfo.Get() then begin
                ...
                EmailMessage.Create(
                    ...
                    '<p>I hope this email finds you well.  This is a kind reminder that your contract with Contract ID - ' + Format(Rec."Contract ID") + ' is set to expire in the next <b> ' + Format(Rec."Renewal Notification to Tenant") + ' </b>. To ensure continuity, we would like to know if you are interested in renewing your contract.</p>' +
