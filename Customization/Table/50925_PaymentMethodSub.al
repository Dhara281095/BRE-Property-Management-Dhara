table 50925 "Payment MethodSub"
{
    ...
    fields
    {
        ...
        field(50123; "Total Amount"; Decimal)
        {
            ...
            CalcFormula = sum("Payment MethodSub".Amount where("Contract ID" = field("Contract ID"), "Tenant ID" = field("Tenant ID")));
        }
        ...
        field(50912; "Total VAT Amount"; Decimal)
        {
            ...
            Editable = false;
            FieldClass = FlowField;
            CalcFormula = sum("Payment MethodSub"."VAT Amount" where("Contract ID" = field("Contract ID"), "Tenant ID" = field("Tenant ID")));
        }
        field(50913; "Total Amount Including VAT"; Decimal)
        {
            ...
            Editable = false;
            FieldClass = FlowField;
            CalcFormula = sum("Payment MethodSub"."Amount Including VAT" where("Contract ID" = field("Contract ID"), "Tenant ID" = field("Tenant ID")));
        }
        ...
        field(50125; "Approval Status"; Enum "Approval Status Enum")
        {
            ...
            var
                ...
                paymentGridRec: Record "Payment MethodSub";
                AllApproved: Boolean;
