// page 50924 "ManuallyApprovalPaymentRequest"
// {
//     PageType = List;
//     SourceTable = "ManualApprovalPaymentRequest";
//     ApplicationArea = All;
//     Caption = 'Manually Approval Payment Request List';
//     UsageCategory = Lists;
//     InsertAllowed = false;
//     ModifyAllowed = true;
//     DeleteAllowed = true;
...
//                 trigger OnAction()
//                 var
//                     SelectedRecs: Record "ManualApprovalPaymentRequest";
...
//     var
//         PaymentChangeReqTable: Record "ManualApprovalPaymentRequest";
//         PaymentModeTable: Record "Payment Mode2";
//         PaymentSchedule: Record "Payment Schedule2";
//         ApprovalRec: Record "ManualApprovalPaymentRequest";
...
//                     PaymentModeTable."Amount Including VAT" := PaymentChangeReqTable."Change Amount Including VAT";
//                     PaymentModeTable.Amount := PaymentChangeReqTable."New Amount";
//                     PaymentModeTable."VAT Amount" := PaymentChangeReqTable."New VAT Amount";
